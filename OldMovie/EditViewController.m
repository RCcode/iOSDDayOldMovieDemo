...
- (void)viewDidLoad {
    ...
    self.filterSwitcherView.filterGroups = @[
                                             ...
                                             [SCFilterGroup filterGroupWithFilter:[SCFilter filterWithName:@"CIPhotoEffectMono"]]
...
- (void)saveToCameraRoll {
    ...
    if (currentFilter == nil) {
        ...
        NSMutableString *toPath = [NSMutableString stringWithFormat:@"%@/%@%@",[NSHomeDirectory() stringByAppendingPathComponent:@"Documents/"],@"finish",@".mp4"];
         NSURL*  outputFileUrl = [NSURL fileURLWithPath:toPath];
